...
const TaskColumn = memo(
  ({ title, tasks = [], columnId, projectId, onDeleteTask, onTaskSelect, searchActive }) => {
    ...
    return (
      <div
        className={`flex-1 min-w-[280px] md:min-w-0 flex flex-col bg-white rounded-2xl shadow-sm
      ...
      {({ toggleSidebar }) => (
        <>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full sm:w-52 pl-9 pr-8 py-2 bg-gradient-to-r from-blue-50 to-blue-100
          ...
          <TaskModal
            ...
            firestoreProjectId={project?.id || selectedProjectId}
          />
